...
public class GamepadPrev2 extends SensorImpl {
	final Logger logger = LoggerFactory.getLogger(GamepadPrev2.class);
	...
	// @Override
	// protected void ioPinList() {
	// List<String> querypins = new ArrayList<>();
	// JInputManager.getInstance().getKeyList(this, querypins);
	// SensorPinImpl p;
