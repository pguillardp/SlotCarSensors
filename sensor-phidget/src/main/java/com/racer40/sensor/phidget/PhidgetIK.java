...
import com.racer40.sensor.common.DateTimeHelper;
import com.racer40.sensor.common.SensorConstants;
import com.racer40.sensor.common.SensorImpl;
...
public abstract class PhidgetIK extends SensorImpl implements EventTarget {
	...
	// com.racer40.sensor.phidget device channels
	...
	/**
	 * starts a com.racer40.sensor.phidget
	 */
	@Override
	public boolean start() {
		...
		try {
			...
			int serial = Integer.parseInt(this.getSetup());
		...
		if (!this.started) {
			this.eventLogger.set("Unable to attach com.racer40.sensor.phidget sn:" + no + "\nError: " + error + "\n"
					+ "Check:\n-serial number\n-com.racer40.sensor.phidget setup with the com.racer40.sensor.phidget controller\n- com.racer40.sensor.phidget controller is closed. ");
		}
		return this.started;
	}
	...
	public void discover(long timeout) {
		...
		if (version != null && !"".equals(version)) {
			this.eventLogger.set("Search for com.racer40.sensor.phidget Interface Kits");
				...
				manager.addAttachListener((ManagerAttachEvent ev) -> {
					...
					try {
						...
						if (!foundSetup.contains(message)) {
							...
							if (sensor != null) {
								// sensor.setVersion(com.racer40.sensor.phidget.getDeviceVersion() + "");
								sensor.setPort("USB");
