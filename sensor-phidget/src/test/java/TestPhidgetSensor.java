 ...
 */
public class TestPhidgetSensor {
	final Logger logger = LoggerFactory.getLogger(TestPhidgetSensor.class);
	static Scanner s = new Scanner(System.in);

	@Test
	public void _1014_87899_direct() {
		try {
			...
			try {
				...
				ch.setDeviceSerialNumber(87899);
				ch.setHubPort(-1);
	...
	@Test
	public void _1014_87899_interactive() {
		try {
			/***
			...
			try {
				...
				// your application
				ChannelInfo channelInfo = new ChannelInfo(); // Information from AskForDeviceParameters(). May be
																// removed
